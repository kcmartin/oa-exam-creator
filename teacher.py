...
# dummy test in case they don't want to make an api call to OpenAI
...
class Teacher:
    ...
    # create full test with dummy test option
    ...
    # get answers
    def extract_answer(self, test, num_questions):
        answers = {1 : ""}
        question_number = 1
        for line in test.split("\n"):
            if not line.startswith("Correct Answer:"):
